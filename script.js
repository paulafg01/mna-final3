...
function renderizarPerguntasCompletas() {
  ...
  const opcoes = [
    ...
    ["0 = desnutrido", "1 = não sabe", "2 = bem nutrido"],
...
function calcularMNACompleto() {
  ...
  let classificacao = "";
  if (total >= 24) classificacao = "Estado nutricional adequado";
  else if (total >= 17) classificacao = "Risco de desnutrição";
